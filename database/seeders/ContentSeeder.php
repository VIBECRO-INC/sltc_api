...
class ContentSeeder extends Seeder {
    public function run(): void {
        ...
        Setting::updateOrCreate(['key'=>'company'],['value'=>['name'=>'SLTC INTER SARL','slogan'=>'Finesse & promptitude !','address'=>'Kouhounou – Cotonou – Bénin','email'=>'contact@sltc-inter.bj','phone_1'=>'01 96 74 89 41','phone_2'=>'01 97 52 58 07']]);
    }
}